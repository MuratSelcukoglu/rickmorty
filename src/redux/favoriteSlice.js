    ...
    addFavorite: (state, action) => {
      ...
      if (!controlItem) {
        state.favoriteItems.push({
          ...
          status: newFavoriteItems.status,
          species: newFavoriteItems.species,
          image: newFavoriteItems.image,
          origin: newFavoriteItems.origin,
          location: newFavoriteItems.location,
        });
      } else {
